...
case ":$PATH:" in
    *:/home/john/.juliaup/bin:*)
        ;;

    *)
        export PATH=/home/john/.juliaup/bin${PATH:+:${PATH}}
        ;;
esac
# Tab completion for juliaup and julia channel selection
[ -f "/home/john/.julia/juliaup/completions/bash.sh" ] && source "/home/john/.julia/juliaup/completions/bash.sh"
